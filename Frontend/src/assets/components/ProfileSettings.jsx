...
//     if (!validateForm()) {
//       setMessage({ text: "Please fix the errors below.", type: "error" });
//       setShowPopup(true); // Show popup on validation failure
//       return;
//     }
...
//         setShowPopup(true); // Show popup on backend rejection
//       }
//     } catch (error) {
...
//           <div className="bg-white rounded-lg p-6 max-w-sm w-full shadow-xl transform transition-all animate-fadeIn">
...
//             <button
//               onClick={closePopup}
//               className="w-full bg-orange-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-orange-700 focus:ring-2 focus:ring-orange-600 focus:outline-none transition duration-300"
//             >
//               Close
//             </button>
//           </div>
